...
class Library {
    ...
    changeReadStatus(a){
        if (a.readBefore == "Have read"){
            a.readBefore = "Haven't yet";
        } else if (a.readBefore == "Haven't yet"){
            a.readBefore = "Have read";
        } else{
            a.readBefore = "Have read";
        }
        this.updateTable();
...
myLibrary.updateTable();

// myLibrary.books.forEach((a, index) => {
